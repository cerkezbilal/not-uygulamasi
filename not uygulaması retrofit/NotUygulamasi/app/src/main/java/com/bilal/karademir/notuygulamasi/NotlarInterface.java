...
public interface NotlarInterface {
    ...
    @FormUrlEncoded
    Call<CRUDCevap> notDuzenle(@Field("not_id") int not_id,@Field("ders_adi") String ders_adi, @Field("not1") int not1,@Field("not2") int not2);

    @POST("notlar/insert_not.php")
    @FormUrlEncoded
    Call<CRUDCevap> notEkle(@Field("ders_adi") String ders_adi, @Field("not1") int not1,@Field("not2") int not2);
